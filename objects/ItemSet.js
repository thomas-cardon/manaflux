...
class ItemSet {
  constructor(key, file, ...metadata) {
    ...
    this.file = (file && file.startsWith('MFLUX_')) ? file : `MFLUX_${this.championKey}${file ? ('_' + file.toLowerCase() + '_') : '_'}${metadata.length > 0 ? metadata.join('_') + '_' : ''}${Mana.gameClient.version}_${Mana.version}.json`;
